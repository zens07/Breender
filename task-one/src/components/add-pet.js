        ...
        <div className="row bg-image-home m-0">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
            <Row className="m-0">
              ...
              <Col lg={8} md={8} sm={8} xs={8} className="px-0 p-5">
                <Card
                  style={{
                    maxHeight: "80vh",
                    maxWidth: "50vh",
